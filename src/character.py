...
class Character(object):
	fields = 'name:unicode,NoneType race_name:str class_name:str hair_name:str var_str:int var_dex:int var_con:int var_int:int xp:int level:int upgrade_points:int per_wc_miss_chance:dict:tuple:#str,int armor:Armor,NoneType weapon:Weapon,NoneType'
